import { app as c, BrowserWindow as d, ipcMain as i, safeStorage as a, session as g } from "electron";
...
c.whenReady().then(() => {
  ...
  i.removeAllListeners("set-secure-token"), i.on("set-secure-token", (o, t, e) => {
    a.isEncryptionAvailable() ? (r = a.encryptString(t), l = e, console.log("[Main] Token encriptado y guardado en memoria segura.")) : (console.warn("[Main] safeStorage no disponible. Token guardado sin encriptar en memoria."), r = Buffer.from(t, "utf-8"), l = e);
  }), i.removeAllListeners("clear-secure-token"), i.on("clear-secure-token", () => {
    r !== null && (r = null, console.log("[Main] Token eliminado de memoria segura."));
  }), g.defaultSession.webRequest.onBeforeSendHeaders((o, t) => {
    if (r && l && o.url.startsWith(l))
      try {
        let e = "";
        a.isEncryptionAvailable() ? e = a.decryptString(r) : e = r.toString("utf-8"), o.requestHeaders.Authorization = `Bearer ${e}`;
      } catch (e) {
