...
import CorrelativoTable from "../ui/admin/CorrelativoTable";
import CorrelativoFormModal from "../ui/admin/CorrelativoFormModal";
import type { Correlativo } from "../model/fiscal.types";

const FiscalSequencesPage: React.FC = () => {
