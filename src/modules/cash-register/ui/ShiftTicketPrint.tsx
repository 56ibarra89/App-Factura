    ...
    <>
      ...
      >
        ...
        <Box mb={2}>
          ...
          <Typography variant="body2" fontFamily="inherit">
            Turno #: {shift.id.split('-')[1]}
          </Typography>
        </Box>

        <Box mb={1} sx={{ borderBottom: "1px dashed black", borderTop: "1px dashed black", py: 0.5 }}>
          <Typography variant="body2" fontFamily="inherit" fontWeight="bold" textAlign="center">
            RESUMEN DE VENTAS
          </Typography>
        </Box>
        ...
        <Box mb={2}>
          <Box display="flex" justifyContent="space-between">
            <Typography variant="body2" fontFamily="inherit">Efectivo:</Typography>
            <Typography variant="body2" fontFamily="inherit">{general.currencySymbol}{shift.totalSales.cash.toFixed(2)}</Typography>
          </Box>
          <Box display="flex" justifyContent="space-between">
            <Typography variant="body2" fontFamily="inherit">Tarjeta:</Typography>
            <Typography variant="body2" fontFamily="inherit">{general.currencySymbol}{shift.totalSales.card.toFixed(2)}</Typography>
          </Box>
          <Box display="flex" justifyContent="space-between">
            <Typography variant="body2" fontFamily="inherit">App/Delivery:</Typography>
            <Typography variant="body2" fontFamily="inherit">{general.currencySymbol}{shift.totalSales.app.toFixed(2)}</Typography>
          </Box>
          <Box display="flex" justifyContent="space-between" mt={1}>
            <Typography variant="body1" fontFamily="inherit" fontWeight="bold">TOTAL VENTAS:</Typography>
            <Typography variant="body1" fontFamily="inherit" fontWeight="bold">{general.currencySymbol}{shift.totalSales.total.toFixed(2)}</Typography>
          </Box>
        </Box>
        ...
        <Box mb={2}>
          <Box display="flex" justifyContent="space-between">
            <Typography variant="body2" fontFamily="inherit">Apertura:</Typography>
            <Typography variant="body2" fontFamily="inherit">{general.currencySymbol}{shift.openingAmount.toFixed(2)}</Typography>
          </Box>
          <Box display="flex" justifyContent="space-between">
            <Typography variant="body2" fontFamily="inherit">Ventas Efectivo:</Typography>
            <Typography variant="body2" fontFamily="inherit">{general.currencySymbol}{shift.totalSales.cash.toFixed(2)}</Typography>
          </Box>
          <Box display="flex" justifyContent="space-between" mt={1}>
        ...
        {shift.notes && (
          <Box mt={2}>
            <Typography variant="body2" fontFamily="inherit" fontWeight="bold">Notas:</Typography>
            <Typography variant="body2" fontFamily="inherit">{shift.notes}</Typography>
          </Box>
        )}
