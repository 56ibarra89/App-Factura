...
import { TaxConfigCard } from "../ui/TaxConfigCard";
import { TaxExemptionToggle } from "../ui/TaxExemptionToggle";

const TaxSettingsPage = () => {
  const { taxes, isExonerated, toggleExoneration, updateTaxRate } = useTaxConfig();
