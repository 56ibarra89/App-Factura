...
import WaiterList from "../ui/admin/waiter-zones/WaiterList";
import WaiterZonesEditor from "../ui/admin/waiter-zones/WaiterZonesEditor";

export default function WaiterZonesPage() {
