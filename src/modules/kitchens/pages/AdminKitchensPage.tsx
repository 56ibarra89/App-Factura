...
import CookAssignmentsSection from "../ui/admin/CookAssignmentsSection";
import KitchenManagementPanel from "../ui/admin/KitchenManagementPanel";
import { useAdminKitchens } from "../hooks/useAdminKitchens";

const AdminKitchensPage = () => {
  const kitchenManager = useAdminKitchens();
