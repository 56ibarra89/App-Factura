...
import type { OrderHistoryGateway } from "../../services/order/orderHistoryGateway";
import { orderHistoryGateway } from "../../services/order/orderHistoryGateway";
...
export function useInvoiceCancellation(
  historyGateway: OrderHistoryGateway =
    orderHistoryGateway,
) {
